...
from src.models.faster_transcriber import FasterPodcastTranscriber
...
if not AUDIO_DIR:
    # Fallback default
    AUDIO_DIR = r"C:\Users\Dell\Downloads\PodcastFillers"
    logger.warning(f"AUDIO_DIR not found in .env. Using fallback: {AUDIO_DIR}")
...
transcriber_model = FasterPodcastTranscriber(model_size="tiny", device="cpu", compute_type="int8")
